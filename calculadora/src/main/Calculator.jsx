...
class Calculator extends Component {
    ...
    addDigit(n) {
        ...
        // somente irá limpar o display se o primeiro digito for 0 ou o AC for digitado
        const currentValue = clearDisplay ? '' : this.state.displayValue
        // se precisar limpar o display o valro será '', serão será o valor informado
